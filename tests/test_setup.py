...
async def test_montague_parser():
    ...
    try:
        ...
        try:
            ...
            print(
                "⚠️  spaCy model not available - run: uv run python -m spacy download en_core_web_sm"
            )
...
async def test_knowledge_types():
    ...
    try:
        ...
        entity = Entity(
            id="test_entity", name="Test Entity", type="Test", confidence=0.9
        )
        ...
        # Test fact creation
        fact = Fact(id="test_fact", content="This is a test fact", confidence=0.8)
...
async def test_server_structure():
    ...
    try:
        from synapse_mcp.server import SynapseServer, mcp
